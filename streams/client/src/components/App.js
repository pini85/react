...
histroy object keeps track of the address bar in your browser. And it is going to extract just that part of the url that the BrowserRouter cares which is after the domain name.
...
Basically asks this question does the string w '/' which is from the extracted path contain in the url?
