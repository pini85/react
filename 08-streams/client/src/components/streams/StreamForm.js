...
Initially we put this logic in the Createform but we want to reuse this Form in our other components. So we have a Form component that has all the logic in it. And we put a callback onSubmit that will pass it to the child components create and edit.
...
Name prop is mandotary. It is the Fields property name which will be linked to redux-forms.
...
We need to wrap StreamForm with redux-form to tell them this is the component it needs to connect to. And thus, we get all the props redux-form gives us.

with redux-form we get the FormProps. The props are all the props we pass to the Field component like label we also get the input props and meta props
